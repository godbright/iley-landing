...
export function PromptInput({ onTransform, onUploadClick }: PromptInputProps) {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto mb-12 px-4">
      <div className="bg-zinc-900 border border-zinc-700 rounded-3xl focus-within:border-[#a3e635] focus-within:ring-2 focus-within:ring-[#a3e635]/20 transition-all shadow-2xl relative backdrop-blur-sm">
        <div className="relative">
          <textarea
            ...
            className="w-full p-6 md:p-8 text-lg md:text-xl placeholder-zinc-500 resize-none focus:outline-none bg-transparent leading-relaxed text-white font-light"
            style={{ 
              height: '130px',
              minHeight: '120px'
            }}
          ...
          <div className="absolute bottom-4 md:bottom-6 right-4 md:right-6 flex items-center gap-3">
            <button 
              ...
              className="w-5 h-5 md:w-10  md:h-10 bg-[#a3e635] text-black rounded-full hover:bg-[#8cd32a] transition-all hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center font-medium shadow-lg"
