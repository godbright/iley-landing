...
export default function PricingSection() {
  ...
  return (
    <section id="pricing" className="py-12 md:py-24 bg-zinc-950 text-white" aria-label="Pricing plans for AI design creation">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-12 md:mb-16">
          {plans.map((plan, index) => (
            <div key={index} className={`relative rounded-2xl p-6 md:p-8 ${
              plan.popular 
              ...
              <div className="text-center mb-8">
                ...
                <div className={`text-2xl md:text-3xl font-bold mb-2 ${plan.popular ? 'text-white' : 'text-white'}`}>
                  {plan.name === 'Creator' ? (
